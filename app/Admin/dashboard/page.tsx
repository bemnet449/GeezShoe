        ...
        <div className="p-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                {[
                    ...
                    { label: "Products In Catalog", value: stats.totalProducts, icon: "👟", color: "from-stone-500 to-stone-400" },
                    ...
                    <div key={i} className="relative group overflow-hidden bg-white p-8 rounded-[2rem] shadow-sm border border-stone-100 hover:shadow-xl hover:shadow-amber-900/5 transition-all duration-500">
                        <div className="absolute top-0 right-0 w-24 h-24 bg-stone-50 rounded-bl-[4rem] -mr-8 -mt-8 group-hover:bg-amber-50 transition-colors duration-500 flex items-center justify-center p-6 text-2xl">
                            {stat.icon}
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Orders Card */}
                <Link href="/Admin/orders" className="lg:col-span-2 group relative overflow-hidden bg-stone-900 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-stone-900/20 hover:-translate-y-1 transition-all duration-500">
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="flex justify-between items-start mb-12">
                            ...
                            <div className="flex flex-col items-end">
                                ...
                                <span className="px-4 py-1.5 bg-amber-500 text-stone-900 rounded-full text-xs font-black uppercase">
                                    {stats.totalOrders} Pending
                                </span>
                            </div>
                        </div>
                        <h2 className="text-4xl font-black mb-4">Manage Orders</h2>
                        <p className="text-white/60 font-medium text-lg max-w-md mb-8">
                            Keep the business moving. Review new customer requests, process payments, and update shipments.
                        </p>
                        <div className="mt-auto flex items-center text-amber-500 font-black uppercase tracking-widest text-sm group-hover:translate-x-2 transition-transform">
                            Open Order Desk
                ...
                {/* Inventory Card */}
                <Link href="/Admin/products" className="group bg-white rounded-[2.5rem] p-10 border-2 border-stone-100 hover:border-amber-600/20 shadow-sm hover:shadow-2xl transition-all duration-500">
                    <div className="h-full flex flex-col">
                        <div className="p-4 bg-amber-50 rounded-2xl w-fit mb-12 group-hover:bg-amber-600 transition-colors duration-500">
                        ...
                        <h2 className="text-3xl font-black text-stone-900 mb-4">Inventory</h2>
                        ...
                        <div className="mt-auto pt-8 border-t border-stone-50 flex items-center justify-between">
                            <span className="text-sm font-black text-stone-900">{stats.totalProducts} Total Items</span>
                            <div className="w-10 h-10 rounded-full bg-stone-900 text-white flex items-center justify-center group-hover:bg-amber-600 transition-colors">
            ...
            {/* Mini Footer */}
            <footer className="mt-20 pt-8 border-t border-stone-100 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase font-black tracking-widest text-stone-400">
                <span>GEEZ SHOE ADMIN v2.5</span>
                <span className="mt-4 md:mt-0 italic">System Status: Optimal</span>
            </footer>
        </div>
    );
};
