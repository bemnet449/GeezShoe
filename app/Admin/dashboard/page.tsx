            ...
            <nav className="bg-white shadow-md border-b border-stone-200">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        ...
                        <h1 className="text-2xl font-bold text-stone-800">GeezShoe Admin</h1>
                    </div>
                    <button
                        onClick={handleLogout}
                        className="bg-gradient-to-r from-red-600 to-red-500 text-white px-5 py-2 rounded-lg font-medium hover:from-red-700 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg"
                    >
                        Logout
                    </button>
                </div>
