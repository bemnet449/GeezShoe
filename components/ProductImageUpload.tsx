...
export default function ProductImageUpload({
    ...
    // Update parent whenever slots change
    ...
    const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>, slotIndex: 0 | 1 | 2) => {
        ...
        if (!productName.trim()) {
            newErrors[slotIndex] = "Enter Product Name first (for file naming)";
            setErrors(newErrors);
            return;
        }
        ...
        try {
            ...
            // If there's an existing image in this slot, we could delete it, 
            // but for safety/simplicity we'll just upload the new one.
            // (Optional: Add cleanup logic here if strict storage management is needed)
                        ...
                        <div key={slotIndex} className="relative group">
                            ...
                            <div className={`
                                ...
                                ${error
                                    ...
                                    : url
                                        ? "border-amber-500 bg-white border-solid"
                                ...
                                {url ? (
                                    ...
                                    <>
                                        ...
                                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-3">
                                            {/* Change Image Button - overlaying input */}
                            ...
                            {/* Error Message */}
                            {error && (
                                <p className="absolute -bottom-6 left-0 right-0 text-center text-xs text-red-500 font-medium truncate">
                                    {error}
                                </p>
                            )}
                        </div>
